    ...
    <div class="account container py-5">
        <div class="row">
            ...
            <div class="col-lg-9 ">
                ...
                <form class="mt-3 account_panel" method="POST" action="{{route('change_password.update')}}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6 mb-3">
                            <label class="font-size-xs text-uppercase font-weight-medium text-dark text-ls mb-0">{{__('New password')}}</label>
                            <input type="password" class="form-control  mt-2" id="firstName" name="password">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="font-size-xs text-uppercase font-weight-medium text-dark text-ls mb-0">{{__('Confirm new password')}}</label>
                            <input type="password" class="form-control  mt-2" id="lastName" name="password_confirmation">
                        </div>
